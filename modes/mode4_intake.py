...
def _seed_examples(track: str) -> list:
    ...
    왜 트랙별인가: 민간 신청자에게 "○○시청 시립 어린이집"을 보여주면 안 된다.
    ...
    return [
        ("🏫 실증 케이스 — 우리 검증 대상. 전 항목 일괄 입력",
         "○○시청에서 시립 어린이집 그린리모델링을 신청합니다. "
         "담당자는 홍길동 주무관, 연락처는 000-0000-0000입니다. "
         "대상은 ○○어린이집, 주소는 ○○시 ○○로, 어린이집이고 "
        ...
        ("🏛 보조율 70% — 기준은 수도권이 아니라 소유 주체다",
         "○○도 ○○군청 소유 시립도서관입니다. 서울시나 중앙행정기관이 아니라 "
...
def _render_chat_tab(session) -> None:
    ...
    placeholder = (
        ...
        else "예: ○○시청이고 연면적 1,251㎡, 사용승인 2014년 어린이집입니다."
    )

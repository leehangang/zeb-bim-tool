...
def render_roi_panel() -> None:
    ...
    <div style="margin-bottom:1rem;">
        ...
        <div style="color:#757575;">
            자연어에서 <b>연면적·보강 면적·목표 등급·소유 주체·증축 여부·공사 기간</b>을 자동 추출해,
            아래를 <b>엔진이 결정론적으로</b> 계산합니다 (숫자는 LLM이 만들지 않습니다).<br>
            <span style="font-size:0.88rem;">
            공사비 <b>07</b> 조달청 단가DB · 간접공사비 <b>08</b> 매트릭스 ·
            보조율 50/70% <b>17</b> 공공 GR 2.0 공고 · 용적률 완화 <b>10</b> 시행령 §11 + <b>06</b> 별표9 ·
            취득세 감면 <b>05</b> 지방세특례 §47조의2 · 인증 수수료·환불 <b>19</b> ZEB 공동고시 별표4
            </span>
        </div>
    </div>
    ...
    with st.expander("💡 예시 입력 — 클릭하면 자동 입력",
        ...
        st.caption(
            "자연어에서 **연면적·보강 면적·목표 등급·소유 주체·증축 여부·공사 기간**을 뽑아 "
            "엔진이 결정론적으로 계산합니다. 아래 문장을 눌러 그대로 실행하거나 숫자만 바꿔 보세요."
        )
        examples = [
            # ① 우리 검증 케이스 — 전 항목을 태운다

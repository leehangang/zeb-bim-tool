...
# ⚠️ roi2_strt / intake_ask는 2026-07-28 익명화 후 capture.js로 다시 찍었다.
#    옛 캡처에는 건물명·기관명이 픽셀로 박혀 있었다 — 확대 상자를 옮겨도 안 지워진다.
#    화면을 다시 찍는 쪽이 맞다. 발표에서 "이게 지금 화면입니다"가 참이어야 하니까.
JOBS = [
    ...
    ("s11", 1, "roi2_strt.png",  953, -241,  -51),
    ("s11", 2, "roi2_strt.png", 1731, -438, -493),
    ("s12", 1, "intake_top.png", 934, -232, -448),
    ("s12", 2, "intake_ask.png",1610, -408, -236),
]
